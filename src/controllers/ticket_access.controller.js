const { ticket_access: ticketAccessModel } = require("../models/index.js");
...
const getDatas = async (req, res) => {
  ...
  const { count, rows } = await ticketAccessModel.findAndCountAll({
    where,
    limit,
    offset,
    order,
...
const getDataTable = async (req, res) => {
  ...
  const data = await ticketAccessModel.findAndCountAll({
    where: whereClause,
    limit,
    offset,
  });
...
const getDataById = async (req, res) => {
  ...
  const findData = await ticketAccessModel.findOne({
    where: { uuid },
  });
...
const createData = async (req, res) => {
  ...
  const newData = await ticketAccessModel.create({
    name,
    sequence,
    code,
    is_active: true,
