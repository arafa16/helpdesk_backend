...
const getDataFirst = async (req, res) => {
  ...
  if (!findData) {
    throw new CustomHttpError("data not found bro", 404);
  }
...
const createData = async (req, res) => {
  ...
  const file_link = `/attributes/images/companies/${file_name}`;
  ...
  file.mv(`./public/attributes/images/companies/${file_name}`, async (err) => {
    if (err) {
