const { ticket_category: ticketCategoryModel } = require("../models/index.js");
...
const getDatas = async (req, res) => {
  ...
  const { count, rows } = await ticketCategoryModel.findAndCountAll({
    where,
    limit,
    offset,
    order,
...
const getDataTable = async (req, res) => {
  ...
  const data = await ticketCategoryModel.findAndCountAll({
    where: whereClause,
    limit,
    offset,
  });
...
const getDataById = async (req, res) => {
  ...
  const findData = await ticketCategoryModel.findOne({
    where: { uuid },
  });
...
const createData = async (req, res) => {
  ...
  const newData = await ticketCategoryModel.create({
    name,
    sequence,
    code,
    is_active: true,
