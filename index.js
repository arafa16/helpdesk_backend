...
const division_router = require("./src/routes/division.route.js");
...
const ticket_trouble_consequence_router = require("./src/routes/ticket_trouble_consequence.route.js");
const ticket_trouble_category_router = require("./src/routes/ticket_trouble_category.route.js");
...
app.use("/api/v1/division", division_router);
...
app.use(
  "/api/v1/ticket_trouble_consequence",
  ticket_trouble_consequence_router,
);
app.use("/api/v1/ticket_trouble_category", ticket_trouble_category_router);
