...
[![Release](https://badgen.net/github/release/arafa16/helpdesk_backend "Release")](https://github.com/arafa16/helpdesk_backend/releases)
...
```bash
git clone https://github.com/arafa16/helpdesk_backend
npm install
```
